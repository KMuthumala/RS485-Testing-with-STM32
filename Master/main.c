...
uint8_t data_rx[14];//={'A','B','C','D','E','F','G','H','I'};
uint8_t data_tx[14]={'1','2','3','4','5','6','7','8','9'};
/* USER CODE BEGIN PFP */
...
int main(void)
{
  ...
  //HAL_UART_Transmit(&huart2,data_tx,10, HAL_MAX_DELAY);
  //stateMachine(TOF1);
  //send(TOF2);
  //stateMachine(TOF2);
  //ready_Tx();

  //sprintf(msg,"Rx--CpltCallback\r\n");
  //HAL_UART_Transmit(&huart2,(uint8_t*)msg, strlen(msg), HAL_MAX_DELAY);
  //HAL_UART_Transmit(&huart2,data_tx, 14, HAL_MAX_DELAY);
  ...
  //ready_Tx();
  //delay(1000);
  //HAL_UART_Transmit_IT(&huart2,data_tx,9);

 //ready_Rx();
//  delay(1000);
//
  //HAL_UART_Receive_IT(&huart2,data_rx,9);
